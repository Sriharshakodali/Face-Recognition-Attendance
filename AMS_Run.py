...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            with open('E:\Attendace_management_system\StudentDetails\StudentDetails.csv', 'a+') as csvFile:
            ...
            while (True):
                ...
                faces = detector.detectMultiScale(gray,minNeighbors=5)
...
def subjectchoose():
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"E:\Attendace_management_system\Attendance\-------Check atttendance-------"')
...
def trainimg():
    ...
    try:
        global faces,Id
        faces,Id = getImagesAndLabels("E:\Attendace_management_system\TrainingImage")
